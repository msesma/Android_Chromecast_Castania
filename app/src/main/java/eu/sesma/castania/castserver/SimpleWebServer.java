...
public class SimpleWebServer extends NanoHTTPD {
    ...
    protected static void registerPluginForMimeType(final String[] indexFiles, final String mimeType,
            final WebServerPlugin plugin, final Map<String, String> commandLineOptions) {
    ...
    private Response respond(final Map<String, String> headers, final IHTTPSession session, String uri) {
        ...
        if (f.isDirectory()) {
            // First look for index files (index.html, index.htm, etc) and if none found, list the directory if
            // readable.
            ...
            if (files.size() > 0) {
                ...
                for (String file : files) {
                    ...
                    if (len < 1024) {
                        ...
                        msg.append(len / (1024 * 1024)).append(".").append(len % (1024 * 1024) / 10 % 100)
                                .append(" MB");
                    }
                    msg.append(")</span></li>");
                }
