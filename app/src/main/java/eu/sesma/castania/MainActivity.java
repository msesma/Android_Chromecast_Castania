                    ...
                    Cast.CastApi.launchApplication(mApiClient, APP_ID, false)
                            .setResultCallback(new ResultCallback<Cast.ApplicationConnectionResult>() {
                                ...
                                public void onResult(final Cast.ApplicationConnectionResult result) {
                                    ...
                                    Log.d(TAG, "ApplicationConnectionResultCallback.onResult: statusCode" + status
                                            .getStatusCode());
                                    if (status.isSuccess()) {
                ...
                public void onStatusUpdated() {
                    ...
                    if (mediaStatus != null) {
                        ...
                        case MediaStatus.PLAYER_STATE_PLAYING:
                            mIsPlaying = true;
                            ((ImageButton) findViewById(R.id.bt_play))
                                    .setImageDrawable(getResources().getDrawable(R.drawable.pause));
                            break;
                        default:
                            mIsPlaying = false;
                            ((ImageButton) findViewById(R.id.bt_play))
    ...
    private void reattachMediaChannel() {
        if (null != mRemoteMediaPlayer && null != mApiClient) {
            try {
                Log.d(TAG, "Registering MediaChannel namespace");
                Cast.CastApi
                        .setMessageReceivedCallbacks(mApiClient, mRemoteMediaPlayer.getNamespace(), mRemoteMediaPlayer);
            } catch (IOException e) {
